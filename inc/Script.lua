...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/moatazkhaledd/moatazfile/master/GetVersion.txt' ) or 0
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Sc_plank"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : بلانك](https://t.me/Sc_plank)' ,nil,inline,msg.id_)
return false
end
...
elseif Text:match(Bot_Name.."كيفك") then 
 ...
 elseif Text== "مساعدة"  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر 🌚❤️")
  ...
  elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"امـر يعيني")
